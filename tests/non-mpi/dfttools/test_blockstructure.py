...
from dcorelib.triqs_compat.utility.h5diff import h5diff, compare, failures
from dcorelib.triqs_compat.gf import *
from dcorelib.triqs_compat.utility.comparison_tests import assert_block_gfs_are_close
...
def test_blockstructure(request):
    org_dir = os.getcwd()
